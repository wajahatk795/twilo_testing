                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                        ...
                        <form action="{{ route('auth.logout') }}" method="POST" style="display: inline;">
                            @csrf
                            <button type="submit" class="dropdown-item d-flex align-items-center gap-2 py-2" style="border: none; background: none; cursor: pointer; width: 100%; text-align: left;">
